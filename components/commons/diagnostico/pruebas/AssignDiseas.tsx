...
export function AssignDiseas({
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    try {
      const response = await fetch("/api/tests/assignDiseas", {
        method: "POST",
      ...
      toast({
        ...
        description: "Se asignaron correctamente a la prueba.",
      })
    ...
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Selecciona una o varias enfermedades para asignar a la prueba.
          </DialogDescription>
        </DialogHeader>
